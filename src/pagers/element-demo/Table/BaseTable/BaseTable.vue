                ...
                <div class="query">
                    <el-row >
                        ...
                        <el-col :span="7" class="row-bg">
                            <el-input v-model="query" placeholder="请输入内容" @keyup.enter.native="exeQuery"/>
                        </el-col>
                        <div v-show="isExpand">
                            <el-col :span="4" class="row-bg">
                                <el-select v-model="type" placeholder="类型" clearable>
                                    <el-option label="商品基础信息" value="metadata"/>
                                    <el-option label="商品销售规格" value="option"/>
                                    <el-option label="商品属性" value="attribute"/>
                                    <el-option label="商品图片" value="image"/>
                                </el-select>
                            </el-col>
                            <el-col :span="4" class="row-bg">
